...
export const LinkCenterOfMass = React.memo(
  ({ link, hovered = false, selected = false }: CenterOfMassProps) => {
    ...
    const pickRadius = hovered ? radius * 3.6 : selected ? radius * 3.4 : radius * 3.2;
