/**
 * URDF Robot Inspection Criteria Configuration
 * Defines evaluation categories, check items, and scoring standards
 */

import type { InspectionCategory, InspectionItem, IssueType } from '../types'
...
/**
 * Calculate score based on issue type
 * @param type Issue type
 * @param hasIssue Whether there is an issue
 * @returns Score (0-10)
 */
...
/**
 * Calculate category score (average of all item scores in the category)
 */
...
/**
 * Calculate overall score (sum of all check item scores)
 * @param categoryScores Category scores
 * @param itemScores All check item scores array
 */
export function calculateOverallScore(
  categoryScores: Record<string, number>,
  itemScores?: number[]
): number {
  // If all check item scores are provided, sum them up
