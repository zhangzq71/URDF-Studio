...
function assertCloseArray(actual: number[] | null | undefined, expected: number[], tolerance: number = 1e-5): void {
...
test('canonical snapshot diagonalizes fullinertia like MuJoCo', () => {
    ...
    assertCloseArray(
        ...
        [0.085821, 0.049222, 0.08626, 1.276e-05, -0.00016022, -0.000414],
        1e-4,
    );
});
