...
function i(r, t = globalThis, a = ['*']) {
  (t.addEventListener('message', function s(l) {
    ...
    Promise.resolve(m)
      ...
      .catch((e) => {
        const [r, n] = v({ value: new TypeError('Unserializable return value'), [o]: 0 });
  ...
  const s = new Proxy(o, {
    get(r, o) {
      ...
      if ('then' === o) {
        ...
        const r = g(e, { type: 'GET', path: n.map((e) => e.toString()) }).then(w);
    ...
    set(r, t, o) {
      l(a);
      const [s, i] = v(o);
      return g(e, { type: 'SET', path: [...n, t].map((e) => e.toString()), value: s }, i).then(w);
    },
    apply(t, o, s) {
      l(a);
      ...
      const [u, c] = m(s);
      return g(e, { type: 'APPLY', path: n.map((e) => e.toString()), argumentList: u }, c).then(w);
    },
    construct(r, t) {
      l(a);
      const [o, s] = m(t);
      return g(e, { type: 'CONSTRUCT', path: n.map((e) => e.toString()), argumentList: o }, s).then(
        w,
      );
    },
  });
...
function g(e, r, t) {
  return new Promise((n) => {
    ...
    (e.addEventListener('message', function r(t) {
      t.data && t.data.id && t.data.id === o && (e.removeEventListener('message', r), n(t.data));
    }),
      e.start && e.start(),
  ...
  *entries(e = !1, r = null) {
    ...
    for (
      ...
      if (e && r !== n.path) this._runCode.skipEntry(this._archive);
        ...
        ((n.fileData = this._wasmModule.HEAPU8.slice(e, e + n.size)), this._wasmModule._free(e));
      }
      yield n;
    }
  }
...
class E {
  ...
  async write(e, r, t, n = null) {
    ...
    for (const { file: r, pathname: t } of e) {
      ...
      (this._runCode.writeArchiveFile(i, t || r.name, e.length, e.ptr), this._runCode.free(e.ptr));
    }
    ...
    async function (e = {}) {
      ...
      if (h) {
        ...
        var m = e(import.meta.url),
          p = m('fs'),
          v = m('path');
        ((f = d ? v.dirname(f) + '/' : m('url').fileURLToPath(new URL('./', import.meta.url))),
          (o = (e, r) => (
      ...
      n.locateFile
        ? H((N = 'libarchive.wasm')) || ((B = N), (N = n.locateFile ? n.locateFile(B, f) : f + B))
      ...
      var oe = {
          ...
          shutdown() {},
          register(e, r) {
            ((oe.ttys[e] = { input: [], output: [], ops: r }), le.registerDevice(e, oe.stream_ops));
          },
          stream_ops: {
            open(e) {
          ...
          default_tty_ops: {
            ...
            fsync(e) {
              e.output && e.output.length > 0 && (_(Q(e.output, 0)), (e.output = []));
            },
            ioctl_tcgets: (e) => ({
              c_iflag: 25856,
              c_oflag: 5,
          ...
          default_tty1_ops: {
            ...
            fsync(e) {
              e.output && e.output.length > 0 && (y(Q(e.output, 0)), (e.output = []));
            },
          },
        },
        ae = (e) => {
        ...
        se = {
          ...
          stream_ops: {
            ...
            write(e, r, t, n, o, a) {
              ...
              if ((se.expandFileStorage(s, o + n), s.contents.subarray && r.subarray))
        ...
        le = {
          ...
          lookupPath(e, r = {}) {
            ...
            for (
              var t = e.split('/').filter((e) => !!e), n = le.root, o = '/', a = 0;
              a < t.length;
              a++
            ) {
              var s = a === t.length - 1;
              ...
              if (
                ...
                (o = Z.join2(o, t[a])),
                le.isMountpoint(n) && (!s || (s && r.follow_mount)) && (n = n.mounted.root),
                !s || r.follow)
              )
                for (var i = 0; le.isLink(n.mode); ) {
                  ...
                  if (
                    ...
                    (n = le.lookupPath(o, { recurse_count: r.recurse_count + 1 }).node),
                    i++ > 40)
                  )
                    throw new le.ErrnoError(32);
                }
          ...
          mount(e, r, t) {
            ...
            if (!o && !a) {
              ...
              if (((t = s.path), (n = s.node), le.isMountpoint(n))) throw new le.ErrnoError(10);
            ...
            return (
              (u.mount = i),
              (i.root = u),
              o ? (le.root = u) : n && ((n.mounted = i), n.mount && n.mount.mounts.push(i)),
              u
            );
          },
          unmount(e) {
          ...
          rename(e, r) {
            ...
            if ('.' !== (c = V.relative(r, o)).charAt(0)) throw new le.ErrnoError(55);
            try {
              u = le.lookupNode(n, i);
            } catch (e) {}
            if (l !== u) {
              ...
              if ((h = u ? le.mayDelete(n, i, d) : le.mayCreate(n, i))) throw new le.ErrnoError(h);
              if (!t.node_ops.rename) throw new le.ErrnoError(63);
              if (le.isMountpoint(l) || (u && le.isMountpoint(u))) throw new le.ErrnoError(10);
              if (n !== t && (h = le.nodePermissions(t, 'w'))) throw new le.ErrnoError(h);
              le.hashRemoveNode(l);
              try {
          ...
          chmod(e, r, t) {
            var n;
            if (
              !(n = 'string' == typeof e ? le.lookupPath(e, { follow: !t }).node : e).node_ops
                .setattr
            )
          ...
          chown(e, r, t, n) {
            var o;
            if (
              !(o = 'string' == typeof e ? le.lookupPath(e, { follow: !n }).node : e).node_ops
                .setattr
            )
              throw new le.ErrnoError(63);
          ...
          truncate(e, r) {
            ...
            var t;
            if (
              !(t = 'string' == typeof e ? le.lookupPath(e, { follow: !0 }).node : e).node_ops
                .setattr
            )
              throw new le.ErrnoError(63);
          ...
          open(e, r, t) {
            ...
            if ((le.isChrdev(o.mode) && (r &= -513), 65536 & r && !le.isDir(o.mode)))
          ...
          createDataFile(e, r, t, n, o, a) {
            var s = r;
            e && ((e = 'string' == typeof e ? e : le.getPath(e)), (s = r ? Z.join2(e, r) : e));
            var i = ue(n, o),
              u = le.create(s, i);
            if (t) {
              if ('string' == typeof t) {
          ...
          forceLoadFile(e) {
            ...
            try {
              ((e.contents = ne(o(e.url), !0)), (e.usedBytes = e.contents.length));
            } catch (e) {
              throw new le.ErrnoError(29);
            }
          },
          createLazyFile(e, r, t, n, o) {
            ...
            return (
              ...
              (l.read = (e, r, t, n, o) => (le.forceLoadFile(u), c(e, r, t, n, o))),
              (l.mmap = (e, r, t, n, o) => {
                le.forceLoadFile(u);
                var a = ae();
        ...
        de = {
          ...
          calculateAt(e, r, t) {
            ...
            var n;
            if (((n = -100 === e ? le.cwd() : de.getStreamFromFD(e).path), 0 == r.length)) {
              if (!t) throw new le.ErrnoError(44);
              return n;
            }
            return Z.join2(n, r);
          ...
          doStat(e, r, t) {
            try {
              ...
              if (e && e.node && Z.normalize(r) !== Z.normalize(le.getPath(e.node))) return -54;
              throw e;
            }
            ((F[t >> 2] = n.dev),
              (F[(t + 4) >> 2] = n.mode),
        ...
        fe = {
          ...
          stream_ops: {
            ...
            fsync: (e) => 28,
            read(e, r, t, n, o) {
              for (var a = e.node.pipe, s = 0, i = 0; i < a.buckets.length; i++) {
                var u = a.buckets[i];
              ...
              for (i = 0; i < a.buckets.length; i++) {
                ...
                if (c <= m) {
                  ...
                  (c < m ? ((p = p.subarray(0, c)), (f.roffset += c)) : h++, l.set(p));
                  break;
                }
            ...
            write(e, r, t, n, o) {
              ...
              var u = null;
              (0 == a.buckets.length
                ? ((u = { buffer: new Uint8Array(fe.BUCKET_BUFFER_SIZE), offset: 0, roffset: 0 }),
                  a.buckets.push(u))
      ...
      var Ue = {
          ...
          t: function (e) {
            try {
              ...
              var r = fe.createPipe();
              return ((F[e >> 2] = r.readable_fd), (F[(e + 4) >> 2] = r.writable_fd), 0);
            } catch (e) {
              if (void 0 === le || 'ErrnoError' !== e.name) throw e;
              return -e.errno;
            }
            ...
            try {
              for (var n = 0, o = 0; o < r; o++) {
                var a = e + 8 * o,
                  ...
                  l = le.getStream(s);
                (l &&
                  ((u = de.DEFAULT_POLLMASK), l.stream_ops.poll && (u = l.stream_ops.poll(l, -1))),
                  (u &= 24 | i) && n++,
                  (S[(a + 6) >> 1] = u));
              }
              return n;
          ...
          l: function (e, r, t) {
            ...
            ((F[t >> 2] = o.getSeconds()),
              ...
              (F[(t + 24) >> 2] = o.getDay()));
            var a = 0 | ge(o);
            ((F[(t + 28) >> 2] = a), (F[(t + 36) >> 2] = -60 * o.getTimezoneOffset()));
        ...
        Le = (function () {
          ...
          function i(e, r) {
            var t;
            return ((Le = e.exports), (g = Le.C), C(), (t = Le.D), T.unshift(t), x(), Le);
          }
          if ((L(), n.instantiateWasm))
            try {
              return n.instantiateWasm(s, i);
            } catch (e) {
              (y(`Module.instantiateWasm callback failed with error: ${e}`), t(e));
            }
          return (
            ((e = w),
            (r = N),
      ...
      ((n._archive_close = (e) => (n._archive_close = Le.L)(e)),
        ...
        (n._finish_archive_write = (e, r) => (n._finish_archive_write = Le.P)(e, r)),
        (n._free = (e) => (n._free = Le.Q)(e)));
      var Oe = () => (Oe = Le.R)();
      ((n._archive_entry_birthtime_nsec = (e) => (n._archive_entry_birthtime_nsec = Le.S)(e)),
        (n._archive_entry_filetype = (e) => (n._archive_entry_filetype = Le.T)(e)),
        (n._archive_entry_mtime_nsec = (e) => (n._archive_entry_mtime_nsec = Le.U)(e)),
        (n._archive_entry_pathname = (e) => (n._archive_entry_pathname = Le.V)(e)),
        (n._archive_entry_pathname_utf8 = (e) => (n._archive_entry_pathname_utf8 = Le.W)(e)),
        (n._archive_entry_size = (e) => (n._archive_entry_size = Le.X)(e)),
        (n._archive_entry_is_encrypted = (e) => (n._archive_entry_is_encrypted = Le.Y)(e)),
        (n._archive_read_has_encrypted_entries = (e) =>
          (n._archive_read_has_encrypted_entries = Le.Z)(e)),
        (n._archive_read_data_skip = (e) => (n._archive_read_data_skip = Le._)(e)));
      var Ne,
        Be = (e) => (Be = Le.aa)(e),
        je = () => (je = Le.ba)(),
        Ie = (e) => (Ie = Le.ca)(e),
...
class S {
  ...
  initFunctions() {
    this.runCode = {
      ...
      finishArchiveWrite: this.cwrap('finish_archive_write', 'number', ['number', 'number']),
